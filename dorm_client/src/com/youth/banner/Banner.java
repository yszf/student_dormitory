            ...
            if (bannerListener != null) {
                view.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Log.e(tag, "娴ｇ姵顒滈崷銊ゅ▏閻€劍妫悧鍫㈠仯閸戣绨ㄦ禒鑸靛复閸欙綇绱濇稉瀣垼閺勵垯绮�1瀵拷婵绱�" +
                                "娑撹桨绨℃担鎾荤崣鐠囬攱娲块幑顫礋setOnBannerListener閿涘奔绗呴弽鍥︾矤0瀵拷婵顓哥粻锟�");
...
//        Log.i(tag,"currentItem: "+currentItem);
    ...
    /**
     * 鎼寸喎绱旀禍鍡樻＋閻楀牊甯撮崣锝忕礉閺傛壆澧楅惃鍕复閸欙絼绗呴弽鍥ㄦЦ娴狅拷1瀵拷婵绱濋崥灞炬鐟欙絽鍠呮稉瀣垼鐡掑﹦鏅梻顕�顣�
     *
     * @param listener
     * @return
     */
