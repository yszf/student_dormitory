			...
			case 0:
				new Thread(){
					public void run() {
						...
						Intent intent = new Intent(ReplyAddActivity.this,ReplyListActivity.class);
				...
				break;
			case 1:
				Toast.makeText(ReplyAddActivity.this, b.getString("msg"),
