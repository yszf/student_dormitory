...
import cn.edu.xsyu.dorm.stu.DormNoticeActivity;
import cn.edu.xsyu.dorm.stu.DormRuleActivity;
import cn.edu.xsyu.dorm.stu.MessageListActivity;
...
public class SysPageActivity3 extends Activity {
	Banner banner;
	List<String> images;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_syspage3);
			...
			public void onClick(View arg0) {
				new Thread(){
					public void run() {
						...
						Intent intent = new Intent(SysPageActivity3.this, DormNoticeActivity.class);
						Bundle extras = new Bundle();
						extras.putString("ID", ID);
						extras.putString("role", role);
						extras.putString("jsonString", jsonString);
						System.out.println("SysPageActivity3==========="+jsonString);
			...
			public void onClick(View arg0) {
				new Thread(){
					public void run() {
						...
						Intent intent = new Intent(SysPageActivity3.this, MessageListActivity.class);	
						Bundle extras = new Bundle();
						extras.putString("ID", ID);
						extras.putString("jsonString",jsonString);
						extras.putString("role", role);
			...
			public void onClick(View arg0) {
				new Thread(){
					public void run() {
						...
						Intent intent = new Intent(SysPageActivity3.this, DormRuleActivity.class);
						Bundle extras = new Bundle();
						extras.putString("ID", ID);
						extras.putString("jsonString", jsonString);
						extras.putString("role", role);
			...
			public void onClick(View arg0) {
				new Thread(){
					public void run() {
						...
						String jsonString = HttpUtils.getJsonContent(path);
				        System.out.println("SysPageActivity3-------------"+jsonString);
				        Intent intent = new Intent(SysPageActivity3.this,RepairListActivity2.class);
						Bundle extras = new Bundle();
						extras.putString("ID", ID); 
						extras.putString("role", role);
						extras.putString("jsonString", jsonString);
			...
			public void onClick(View arg0) {
				new Thread(){
					public void run() {
				        ...
				        System.out.println("SysPageActivity3-------------"+jsonString);
				        Intent intent = new Intent(SysPageActivity3.this,
