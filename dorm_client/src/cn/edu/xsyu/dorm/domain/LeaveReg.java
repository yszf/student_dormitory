...
public class LeaveReg {
	...
	public String toString() {
		return "LeaveReg [regID=" + regID + ", reason=" + reason
				+ ", destination=" + destination + ", leaveTime=" + leaveTime
				+ ", backTime=" + backTime + ", phone=" + phone
				+ ", emergenceContact=" + emergenceContact + ", emergenceTel="
				+ emergenceTel + ", regTime=" + regTime + ", studentID="
				+ studentID + "]";
	}
