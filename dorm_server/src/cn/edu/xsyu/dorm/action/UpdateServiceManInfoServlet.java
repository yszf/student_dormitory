...
public class UpdateServiceManInfoServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String serviceManID = recvJO.getString("serviceManID");
		serviceMan.setName(recvJO.getString("name"));
		serviceMan.setTime(recvJO.getString("time"));
		serviceMan.setEmail(recvJO.getString("email"));
		serviceMan.setServiceManID(serviceManID);
		
		if(serviceManDaoImpl.updateServiceMan(serviceMan) < 1){
