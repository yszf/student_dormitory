...
public class ChangeNoticeServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String content = recvJO.getString("content");
		String title = recvJO.getString("title");
		...
		notice.setIssuer(buildingManager.getName());
		notice.setTitle(title);
		
		if(noticeDaoImpl.changeNotcie(notice) < 1){
